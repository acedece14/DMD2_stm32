...
class DMDFrame
{
 ...
 public:
  ...
  // Text primitives
  void selectFont(const unsigned char * font);
  ...
  int charWidth(const unsigned char letter, const uint8_t *font = NULL);
...
{
public:
  SoftDMD(unsigned char panelsWide, unsigned char panelsHigh);
